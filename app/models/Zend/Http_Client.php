 ...
 * @see Zend_Loader
 */
require_once path('app') .'models/Zend/Loader.php';


/**
 * @see Zend_Uri
 */
require_once path('app') .'models/Zend/Uri.php';


/**
 * @see Zend_Http_Client_Adapter_Interface
 */
require_once path('app') .'models/Zend/Http_Client_Adapter_Interface.php';


/**
 * @see Zend_Http_Response
 */
require_once path('app') .'models/Zend/Http_Response.php';
