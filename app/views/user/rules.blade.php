            ...
            <table class="table table-condensed" id="messageRules">
                ...
                <tbody>
                    <tr id="baseRow">
                        ...
                        <td class="text-center"><i class="icon-arrow-right"></i></td>
                        <td style="width: 45%;">
...
@section('js')
    <script>
        $.AjaxSubmit('/{{ Request::path() }}', 'Your password has been updated.');

        function addRule() {
            var base = $('#baseRow');
            var clone = base.clone();

            clone.find('td:last').html('<a href="javascript: void(0);" onClick="removeRow(this);" style="padding-top: 150px;"><i class="icon-remove-sign"></i></a>');
